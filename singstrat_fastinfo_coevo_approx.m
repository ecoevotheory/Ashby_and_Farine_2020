function [singstrat,outcome] = singstrat_fastinfo_coevo_approx(a,cmin,cmax,d,kappa,gamma,sigma,tau,res1)
...
c(c==0)=[];
[w_1,ES] = fitness_grad_sign_fastinfo_coevo_approx(a,c,d,kappa,gamma,sigma,tau);
