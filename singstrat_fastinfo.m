function [singstrat,outcome] = singstrat_fastinfo(a,cmin,cmax,d,alpha,beta,gamma,sigma,tau,res1)
...
c(c==0)=[];
[w_1,ES] = fitness_grad_sign_fastinfo(a,c,d,alpha,beta,gamma,sigma,tau);
